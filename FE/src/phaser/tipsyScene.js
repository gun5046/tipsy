...
import tipsy_floor_wall from '../assets/tipsyMap/FloorAndGround.png';
import tipsy_office from '../assets/tipsyMap/Modern_Office.png';
import tipsy_deco from '../assets/tipsyMap/library.png';
import tipsy_table1 from '../assets/tipsyMap/table1.png';
import tipsy_table2 from '../assets/tipsyMap/table2.png';
import tipsy_table3 from '../assets/tipsyMap/table3.png';
import tipsy_table4 from '../assets/tipsyMap/table4.png';
import tipsy_chair from '../assets/tipsyMap/chair.png';
import tipsy_generic from '../assets/tipsyMap/Generic.png';
import tipsy_logo1 from '../assets/tipsyMap/tipsy_logo1.png';
import tipsy_logo2 from '../assets/tipsyMap/tipsy_logo2.png';
import tipsy_name from '../assets/tipsyMap/name.png';
...
import tipsy_map from '../assets/tipsyMap/tipsy_map.json';
...
class tipsyScene extends Phaser.Scene {
    constructor () {
        super('tipsymap');
    }
    ...
    preload ()
    {
        ...
        // 타일맵 이미지 불러오기
        this.load.image('tilesFloorWall', tipsy_floor_wall);
        this.load.image('tilesOffice', tipsy_office);
        this.load.image('tilesDeco', tipsy_deco);
        this.load.image('tilesGene', tipsy_generic);
        this.load.image('tileslogo1', tipsy_logo1);
        this.load.image('tileslogo2', tipsy_logo2);
        this.load.image('tilesname', tipsy_name);

        this.load.image('popup', popup)
        this.load.image('bu', bu)

        // tableObject의 책상 이미지 불러오기
        this.load.image('tilesTable1', tipsy_table1);
        this.load.spritesheet('tables1', tipsy_table1, {
            frameWidth: 80,
            frameHeight: 48,
        })
        this.load.image('tilesTable2', tipsy_table2);
        this.load.spritesheet('tables2', tipsy_table2, {
            frameWidth: 36,
            frameHeight: 68,
        })
        this.load.image('tilesTable3', tipsy_table3);
        this.load.spritesheet('tables3', tipsy_table3, {
            frameWidth: 38,
            frameHeight: 80,
        })
        this.load.image('tilesTable4', tipsy_table4);
        this.load.spritesheet('tables4', tipsy_table4, {
            frameWidth: 78,
            frameHeight: 36,
        })
        
        this.load.image('tilesChair', tipsy_chair);
        this.load.spritesheet('chairs', tipsy_chair, {
            frameWidth: 32,
            frameHeight: 64,
        })
        
        // 타일맵 Json 불러오기
        this.load.tilemapTiledJSON('map', tipsy_map)
    ...
    create ()
    {
        ...
        const logoTileset1 = map.addTilesetImage("tipsylogo1",'tileslogo1');
        const logoTileset2 = map.addTilesetImage("tipsylogo2",'tileslogo2');
